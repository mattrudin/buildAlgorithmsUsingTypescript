// quickSort algo with the partition function as core
...
//uses side-effects (alters the array in the quickSort function above)
export const partition = (array: number[], start: number, before: number): void => {
...
// more information about quickSort algo --> https://khan4019.github.io/front-end-Interview-Questions/sort.html#quickSort
